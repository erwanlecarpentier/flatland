...
def plot(path, args, color, mrk, fcc, lw, ls, oluct_lo_mea):
	...
	l = plot_error_bar(ax2, fp_range_val, cp_mea, cp_std, color, mrk, fcc, lw, ls, take_log)
...
f, (ax1, ax2) = plt.subplots(2, 1, sharex=True, figsize=(8.0,15.0))
...
lw = 2.3
args = [fp_range, fp_range_val, take_log, ax1, ax2]
...
font.set_size('xx-large') # x-large
#font.set_weight('light')

labsz = 13
xlab = 'Probabilité de faux pas'
ylab1 = 'Coût (nombre d\'étapes\nde décisions)'
ylab2 = 'Coût de calcul (ms)'
#ylab2 = 'Mean loss\nrelatively to\nOLUCT loss'
#ylab3 = 'Computational\ncost (ms)'
#ylab4 = 'Number of\ncalls'

apply_label(ax1,xlab,ylab1,font,False)
apply_label(ax2,xlab,ylab2,font,False)
...
ax2.legend(l, lg, numpoints=1, prop=font, bbox_to_anchor=(0., -.4, 1., .102), loc='lower center', ncol=3, mode="expand", borderaxespad=0., frameon=False)
#ax2.legend(l, lg, numpoints=1, prop=font, bbox_to_anchor=(0., -0.8, 1., .102), loc='lower center', ncol=3, mode="expand", borderaxespad=0., frameon=False)
