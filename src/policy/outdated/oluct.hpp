...
public:
     ...
     * @param {const AC &} a; copy of the action
     ...
     */
    node * expand(node &v) {
        AC nodes_action = v.get_next_expansion_action();
     ...
     * higher value).
     */
    AC get_recommended_action(const node &v, unsigned &indice) {
